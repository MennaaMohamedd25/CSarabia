...
const socialMediaLogos = [{ src: logoT, alt: "twitter" }];
  ...
  "
        ...
        >
          <h2 className="font-bold text-[40px]">
            Work with the Trusted Leader in Chemical Cleaning Services In Saudi
            Arabia
          </h2>
          ...
          <Link
            to="contact-us"
            className="bg-secondery text=[16px] text-[#FFFF] px-[40px] py-[18px] rounded-[50px]"
          >
            Contact Us
          </Link>
        </div>
      ...
      <footer className="w-full bg-vanish text-white pt-[2rem] pb-[2rem] text-center xl:text-start xl:pt-[190px] lg:text-start lg:pt-[190px] mt-[40px]">
        {" "}
        {/* Set footer as relative */}
          ...
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="flex-col items-center justify-center md:justify-start mb-4 md:mb-0 ">
              <img
                src={logo}
                alt="logo csarabia"
                className="m-auto xl:ml-0 lg:ml-0"
              />
              <p className="my-[2rem] w-[302px] text-secondery sm:mx-auto xs:mx-auto">
                Building a legacy of service excellence and technical precision
                for the future of Saudi Arabia’s oil & gas sector.{" "}
              </p>
              <div className="flex space-x-2 mb-[2rem] gap-6 justify-center xl:justify-normal lg:justify-normal">
                {socialMediaLogos.map((logo, index) => (
                  <Link
                    to="#"
                    key={index}
                    className="bg-secondery rounded-full p-2 flex items-center justify-center"
                  >
            ...
            <div className="flex flex-col md:flex-row justify-between w-full md:w-auto gap-8 lg:gap-[6rem] xl:gap-[6rem]">
              ...
              <div className="flex flex-col mb-4 md:mb-0">
                <h3 className="font-semibold mb-2 text-secondery text-[18px]">
                  Services
                </h3>
                <ul>
                  {servicesLinks.map((link, index) => (
                    <li key={index}>
                      <Link
                        to={link.path}
                        className="text-secondery text-[14px] hover:text-primary ease-in-out"
                      >
                        {link.name}
                      </Link>
                    </li>
              ...
              <div className="flex flex-col mb-4 md:mb-0 items-center xl:items-start lg:items-start">
                ...
                <div
                  ...
                  style={{ width: "320px", padding: "16px 0px" }}
                >
                  <input
                    type="email"
                  ...
                  />
                  <button
                    className="bg-primary text-white p-[16px]"
                    style={{ borderRadius: "0px 8px 8px 0px", height: "56px" }}
                  >
                    Join
                  </button>
                </div>
