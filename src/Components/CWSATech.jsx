  ...
  return (
    <div className='w-[95%] mx-auto text-start px-[16px] py-[2.5rem]  mb-[2.5rem] md:text-left xl:px-[24px] lg:px-[24px] bg-primary rounded-[32px] text-[#FFF]'>
      ...
      <ul className='list-disc ml-5'>
        ...
        <li>Retrofit and Upgrade of Existing Vessels:Existing underperforming separation vessels can be upgraded by retrofitting the Stauper Coalescence Chamber into the vessel. This upgrade will improve oil from water separation, degassing of the water while improving flow capacity.  The retrofit process is completed in weeks and as a result existing equipment can be utilized. Improved separation will reduce the need for costly chemicals and improve environmental footprint. All work is done without the need for recertification of the pressure vessel.</li>
      </ul>
    </div>
  )
}

export default CWSATech
